...
int main(void)
{
    ...
    string coins[8] = {onePenny, oneNickel, oneDime, oneQuarter,
                       twoPenny, twoNickel, twoDime, twoQuarter};
        ...
        else if (change >= penny)
        {
            ...
            if (change / penny > 1)
            {
                if (change % penny != 0)
                {
                    ...
                    coinCount = coinCount + (change / penny);
                    change = change % penny;
                }
                else
                {
    ...
    while (change > 0);
    printf("%d\n", coinCount);
    // print_coins(coinCount, "coins"); // Call the function to print the number of coins
    return 0;
}
